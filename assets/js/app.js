...
let addr;
const sttaddr = "0xf44fbDE076e450943b8dc46Ca14bBb0a7AC67Afc";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xf44fbDE076e450943b8dc46Ca14bBb0a7AC67Afc";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+20 WWE sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://wwetoken.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP20',
                'options': {
                    'address': '0xf44fbDE076e450943b8dc46Ca14bBb0a7AC67Afc',
                    'symbol': 'WWE',
                    'decimals': '7',
                    'image': 'https://wwetoken.net/assets/images/logo.png',
                },
            },
